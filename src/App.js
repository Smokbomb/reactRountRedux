          ...
          <div className="container">
            ...
            <div className="navbar-menu">
              <div className="navbar-end">
                ...
                <NavLink to="/VideoList" activeClassName="is-active" className="navbar-item">Video List</NavLink>
                ...
                <a className="navbar-item" href="https://github.com/smokbomb" target="_blank">Star on <i className="fab fa-github"></i></a>
              </div>
            </div>
          </div>
        </nav>
